...
std::shared_ptr<uvloop::Msr> uvloop::Msr::get()
{
...
bool uvloop::Msr::write(uint32_t reg, uint64_t value, int32_t cpu, uint64_t mask, bool verbose)
{
...
uvloop::MsrItem uvloop::Msr::read(uint32_t reg, int32_t cpu, bool verbose) const
{
    uint64_t value = 0;
