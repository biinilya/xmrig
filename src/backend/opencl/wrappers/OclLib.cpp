...
#   define LOG_REFS(x, ...) uvloop::Log::print(uvloop::Log::WARNING, x, ##__VA_ARGS__)
#endif
...
bool uvloop::OclLib::init(const char *fileName)
{
    if (!m_initialized) {
...
const char *uvloop::OclLib::lastError()
{
    return uv_dlerror(&oclLib);
}


void uvloop::OclLib::close()
{
    uv_dlclose(&oclLib);
}


bool uvloop::OclLib::load()
{
    try {
...
uvloop::String uvloop::OclLib::defaultLoader()
{
...
cl_command_queue uvloop::OclLib::createCommandQueue(cl_context context, cl_device_id device, cl_int *errcode_ret) noexcept
{
...
cl_command_queue uvloop::OclLib::createCommandQueue(cl_context context, cl_device_id device)
{
    cl_int ret = 0;
...
cl_context uvloop::OclLib::createContext(const cl_context_properties *properties, cl_uint num_devices, const cl_device_id *devices, void (CL_CALLBACK *pfn_notify)(const char *, const void *, size_t, void *), void *user_data, cl_int *errcode_ret)
{
...
cl_context uvloop::OclLib::createContext(const std::vector<cl_device_id> &ids)
{
    cl_int ret = 0;
...
cl_int uvloop::OclLib::buildProgram(cl_program program, cl_uint num_devices, const cl_device_id *device_list, const char *options, void (CL_CALLBACK *pfn_notify)(cl_program program, void *user_data), void *user_data) noexcept
{
...
cl_int uvloop::OclLib::enqueueNDRangeKernel(cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim, const size_t *global_work_offset, const size_t *global_work_size, const size_t *local_work_size, cl_uint num_events_in_wait_list, const cl_event *event_wait_list, cl_event *event) noexcept
{
...
cl_int uvloop::OclLib::enqueueReadBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t size, void *ptr, cl_uint num_events_in_wait_list, const cl_event *event_wait_list, cl_event *event) noexcept
{
...
cl_int uvloop::OclLib::enqueueWriteBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void *ptr, cl_uint num_events_in_wait_list, const cl_event *event_wait_list, cl_event *event) noexcept
{
...
cl_int uvloop::OclLib::finish(cl_command_queue command_queue) noexcept
{
...
cl_int uvloop::OclLib::getCommandQueueInfo(cl_command_queue command_queue, cl_command_queue_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
    return pGetCommandQueueInfo(command_queue, param_name, param_value_size, param_value, param_value_size_ret);
}


cl_int uvloop::OclLib::getContextInfo(cl_context context, cl_context_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
    return pGetContextInfo(context, param_name, param_value_size, param_value, param_value_size_ret);
}


cl_int uvloop::OclLib::getDeviceIDs(cl_platform_id platform, cl_device_type device_type, cl_uint num_entries, cl_device_id *devices, cl_uint *num_devices) noexcept
{
...
cl_int uvloop::OclLib::getDeviceInfo(cl_device_id device, cl_device_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
...
cl_int uvloop::OclLib::getKernelInfo(cl_kernel kernel, cl_kernel_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
    return pGetKernelInfo(kernel, param_name, param_value_size, param_value, param_value_size_ret);
}


cl_int uvloop::OclLib::getMemObjectInfo(cl_mem memobj, cl_mem_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
    return pGetMemObjectInfo(memobj, param_name, param_value_size, param_value, param_value_size_ret);
}


cl_int uvloop::OclLib::getPlatformIDs(cl_uint num_entries, cl_platform_id *platforms, cl_uint *num_platforms)
{
...
cl_int uvloop::OclLib::getPlatformInfo(cl_platform_id platform, cl_platform_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
...
cl_int uvloop::OclLib::getProgramBuildInfo(cl_program program, cl_device_id device, cl_program_build_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret) noexcept
{
...
cl_int uvloop::OclLib::getProgramInfo(cl_program program, cl_program_info param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret)
{
...
cl_int uvloop::OclLib::release(cl_command_queue command_queue) noexcept
{
...
cl_int uvloop::OclLib::release(cl_context context) noexcept
{
...
cl_int uvloop::OclLib::release(cl_device_id id) noexcept
{
...
cl_int uvloop::OclLib::release(cl_kernel kernel) noexcept
{
...
cl_int uvloop::OclLib::release(cl_mem mem_obj) noexcept
{
...
cl_int uvloop::OclLib::release(cl_program program) noexcept
{
...
cl_int uvloop::OclLib::setKernelArg(cl_kernel kernel, cl_uint arg_index, size_t arg_size, const void *arg_value) noexcept
{
...
cl_int uvloop::OclLib::unloadPlatformCompiler(cl_platform_id platform) noexcept
{
    return pUnloadPlatformCompiler(platform);
}


cl_kernel uvloop::OclLib::createKernel(cl_program program, const char *kernel_name, cl_int *errcode_ret) noexcept
{
...
cl_kernel uvloop::OclLib::createKernel(cl_program program, const char *kernel_name)
{
    cl_int ret = 0;
...
cl_mem uvloop::OclLib::createBuffer(cl_context context, cl_mem_flags flags, size_t size, void *host_ptr)
{
    cl_int ret = 0;
...
cl_mem uvloop::OclLib::createBuffer(cl_context context, cl_mem_flags flags, size_t size, void *host_ptr, cl_int *errcode_ret) noexcept
{
...
cl_mem uvloop::OclLib::createSubBuffer(cl_mem buffer, cl_mem_flags flags, size_t offset, size_t size, cl_int *errcode_ret) noexcept
{
...
cl_mem uvloop::OclLib::createSubBuffer(cl_mem buffer, cl_mem_flags flags, size_t offset, size_t size)
{
    cl_int ret = 0;
...
cl_mem uvloop::OclLib::retain(cl_mem memobj) noexcept
{
...
cl_program uvloop::OclLib::createProgramWithBinary(cl_context context, cl_uint num_devices, const cl_device_id *device_list, const size_t *lengths, const unsigned char **binaries, cl_int *binary_status, cl_int *errcode_ret) noexcept
{
...
cl_program uvloop::OclLib::createProgramWithSource(cl_context context, cl_uint count, const char **strings, const size_t *lengths, cl_int *errcode_ret) noexcept
{
...
cl_program uvloop::OclLib::retain(cl_program program) noexcept
{
...
cl_uint uvloop::OclLib::getNumPlatforms() noexcept
{
    cl_uint count   = 0;
    cl_int ret      = 0;
...
cl_uint uvloop::OclLib::getUint(cl_command_queue command_queue, cl_command_queue_info param_name, cl_uint defaultValue) noexcept
{
...
cl_uint uvloop::OclLib::getUint(cl_context context, cl_context_info param_name, cl_uint defaultValue) noexcept
{
...
cl_uint uvloop::OclLib::getUint(cl_device_id id, cl_device_info param, cl_uint defaultValue) noexcept
{
...
cl_uint uvloop::OclLib::getUint(cl_kernel kernel, cl_kernel_info  param_name, cl_uint defaultValue) noexcept
{
...
cl_uint uvloop::OclLib::getUint(cl_mem memobj, cl_mem_info param_name, cl_uint defaultValue) noexcept
{
...
cl_uint uvloop::OclLib::getUint(cl_program program, cl_program_info param, cl_uint defaultValue) noexcept
{
...
cl_ulong uvloop::OclLib::getUlong(cl_device_id id, cl_device_info param, cl_ulong defaultValue) noexcept
{
...
cl_ulong uvloop::OclLib::getUlong(cl_mem memobj, cl_mem_info param_name, cl_ulong defaultValue) noexcept
{
...
std::vector<cl_platform_id> uvloop::OclLib::getPlatformIDs() noexcept
{
...
uvloop::String uvloop::OclLib::getProgramBuildLog(cl_program program, cl_device_id device) noexcept
{
    size_t size = 0;
...
uvloop::String uvloop::OclLib::getString(cl_device_id id, cl_device_info param) noexcept
{
    return getOclString(OclLib::getDeviceInfo, id, param);
}


uvloop::String uvloop::OclLib::getString(cl_kernel kernel, cl_kernel_info param_name) noexcept
{
    return getOclString(OclLib::getKernelInfo, kernel, param_name);
}


uvloop::String uvloop::OclLib::getString(cl_platform_id platform, cl_platform_info param_name) noexcept
{
    return getOclString(OclLib::getPlatformInfo, platform, param_name);
}


uvloop::String uvloop::OclLib::getString(cl_program program, cl_program_info param_name) noexcept
{
