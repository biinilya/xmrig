...
void uvloop::AstroBWT_SHA3Kernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void uvloop::AstroBWT_SHA3Kernel::setArgs(cl_mem inputs, cl_mem input_sizes, uint32_t input_stride, cl_mem output_salsa20_keys)
{
