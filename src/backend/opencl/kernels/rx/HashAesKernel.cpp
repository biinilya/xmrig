...
void uvloop::HashAesKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void uvloop::HashAesKernel::setArgs(cl_mem input, cl_mem hash, uint32_t hashStrideBytes, uint32_t batch_size)
{
