...
bool uvloop::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool uvloop::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t uvloop::LinuxMemory::read(const char *path)
{
